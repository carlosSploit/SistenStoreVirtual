				...
				<tbody>
					<?php foreach ($datos as $dato) { ?>
						<tr>
							...
							<td>
								<a href="#" data-href="<?php echo base_url() . "index.php/categorias/reingresar/" . $dato->id ?>" data-toggle="modal" data-target="#confirm-delete" data-placement="top" title="Reingresar registro">
