...
<div class="row">
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-primary o-hidden h-100 shadowgre">
			<div class="card-body">
			...
			<a class="card-footer text-white clearfix small z-1" href="<?php echo base_url() ?>index.php/productos">
	...
	<div class="col-xl-3 col-sm-6 mb-3 ">
		<div class="card text-white bg-success o-hidden h-100 shadowgre">
			<div class="card-body">
				<div class="card-body-icon">
	...
	<div class="col-xl-3 col-sm-6 mb-3">
		<div class="card text-white bg-danger o-hidden h-100 shadowgre">
			<div class="card-body">
				<div class="card-body-icon">
